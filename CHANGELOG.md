...
- Versions 1–40, error correction levels L/M/Q/H, all eight data masks with
  ...
  UTF-8) and Kanji (Shift-JIS) modes plus ECI. Automatic mode selection chooses a
  single best-fit mode; mixed-mode segmentation is available via encode-segments.
  Micro QR, FNC1 (GS1) and Structured Append are not supported.
